...
import { ActivityIndicator, Image, StyleSheet, Text, TouchableOpacity, View, Alert, Modal, ScrollView, TextInput, KeyboardAvoidingView, Platform, Keyboard, FlatList, Linking } from 'react-native';
